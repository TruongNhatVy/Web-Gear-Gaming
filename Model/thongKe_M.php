...
class ThongKe_M
{
    public function thongKeSanPhamBanChayNhat()
    {
        ...
        $query = 'SELECT sanpham.MaSanPham,sanpham.Anh,sanpham.TenSanPham,danhmuc.TenDanhMuc,thuonghieu.TenThuongHieu,SUM(chitietdonhang.SoLuong) as SoLuong,chitietdonhang.DonGia,SUM(chitietdonhang.ThanhTien) as ThanhTien';
