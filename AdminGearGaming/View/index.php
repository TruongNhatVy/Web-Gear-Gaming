                                            ...
                                            if($tinhtrang=='db' || empty($tinhtrang)){
													...
													echo'<tr>
														...
														<td>
															<div class="rf" style="display: flex; justify-content: space-around;">
																<a href="index.php?MaSanPham='.$sp['MaSanPham'].'&id=0"><i class="glyphicon glyphicon-trash"></i></a>
												...
												foreach($p->getAllNB() as $spnb){
													echo'<tr>
														...
														<td>
                                                            <div class="rf" style="display: flex; justify-content: space-around;">
                                                            <a href="index.php?MaSanPham='.$spnb['MaSanPham'].'&id=1"><i class="glyphicon glyphicon-repeat"></i></a>
                                                            </div>
														</td>
													</tr>';
												}
