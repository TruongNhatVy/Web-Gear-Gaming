                        ...
                        <div class="col-md-12">
                            <form role="form" method="post" enctype="multipart/form-data">
                                <?php
                                    ...
                                    <div class="form-group">
                                    <label>Đề xuất sản phẩm nổi bật của cửa hàng</label>
                                    <select class="form-control" name="dexuat" id="dexuat">';
                                        if($loaishow == 1){
                                    ...
                                    echo'</select></div><div class="form-group" style="margin-top= 10px;">
                                        <label>Giá</label>
                                ...
                                switch($_POST['nut']){
                                    case 'Change':{
                                        if($_REQUEST['tensp']=="" || $_REQUEST['gia']=="" || $_REQUEST['mota']==""){
                                            ...
                                            $sanpham=['TenSanPham' => $_REQUEST['tensp'], 'Gia' => $_REQUEST['gia'],'LoaiShow' =>$_REQUEST['dexuat'], 'MoTa' => $_REQUEST['mota'], 'Anh' => $img];
