						...
						<div class="bootstrap-table">
							<div class="fixed-table-toolbar">
								<div class="btn pull-left">
									<form method="get">
										<a class="btn btn-default" href="insert-product.php" disabled="disabled"><i class="glyphicon glyphicon-plus-sign" style="margin-top: 1px"></i> Thêm mới sản phẩm</a>
                                        <label>
													...
													echo'<tr>
														...
														<td>
															<div class="rf" style="display: flex; justify-content: space-around;">
																<a href="thukhoindex.php?MaSanPham='.$sp['MaSanPham'].'"><i class="glyphicon glyphicon-trash"></i></a>
																<a href="thukhoupdate-product.php?MaSanPham='.$sp['MaSanPham'].'"><i class="glyphicon glyphicon-pencil"></i></a>
															</div>
														</td>
													</tr>';
												}
