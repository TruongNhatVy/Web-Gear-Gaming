          ...
          <div class="row">
            <div class="col-main col-sm-9 col-sm-push-3">
              <article class="col-main">
                <div class="page-header">
                  <h2>Các sản phẩm của thương hiệu <?php 
                    $TH=$_GET['TH'];
                    for($j=0;$j<sizeof($kq);$j++){
                      for($o=0;$o<sizeof($sanpham);$o++){
                          if($TH==$kq[$j]['MaThuongHieu']){
                            echo $kq[$j]['TenThuongHieu'];
                            break;
                          }}}
                  ?></h2>
                </div>
            ...
            <div class="col-left sidebar col-sm-3 col-xs-12 col-sm-pull-9">
              ...
              <div class="side-nav-categories">
                  <div class="block-title"> CÁC THƯƠNG HIỆU KHÁC </div>
                  <!--block-title--> 
                  <!-- BEGIN BOX-CATEGORY -->
                        ...
                        for($j=0;$j<sizeof($kq);$j++){
                          for($o=0;$o<sizeof($sanpham);$o++){
                              if($sanpham[$o]==$kq[$j]['MaThuongHieu']){
                                if ($kq[$j]['MaThuongHieu'] != $TH){
                                  echo '<li class="last"><a href="thuonghieu.php?TH='.$kq[$j]['MaThuongHieu'].'"><span>'.$kq[$j]['TenThuongHieu'].'</span></a></li>';
                                  break;
                                }}}}
                    ?>
                    </ul>
