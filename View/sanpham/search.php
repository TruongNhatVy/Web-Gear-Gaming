      ...
      for ($j = 0; $j < sizeof($fullsp); $j++) {
        echo '<li class="item col-lg-4 col-md-3 col-sm-4 col-xs-6">
                      <div class="item-inner">
                        <div class="item-img">
                          <div class="item-img-info"> <a href="chitietsp.php?SP=' . $fullsp[$j]['MaSanPham'] . '" title="Sample Product" class="product-image"> <img width=170 height=250 src="../../products-images/' . $fullsp[$j]['Anh'] . '" alt="Sample Product"> </a>
                          </div>
                        </div>
                        <div class="item-info">
      ...
      <div class="main-container col2-left-layout bounceInUp animated">
        ...
        for ($i = 0; $i < sizeof($spoke); $i++) {
          echo '<li class="item col-lg-4 col-md-3 col-sm-4 col-xs-6">
                      <div class="item-inner">
                        <div class="item-img">
                          <div class="item-img-info"> <a href="chitietsp.php?SP=' . $spoke[$i]['MaSanPham'] . '" title="Sample Product" class="product-image"> <img width=170 height=250 src="../../products-images/' . $spoke[$i]['Anh'] . '" alt="Sample Product"> </a>
                          </div>
                        </div>
                        <div class="item-info">
                          <div class="info-inner">
