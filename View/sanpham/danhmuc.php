                      ...
                      for($j = 0 ; $j < sizeof($fullsp); $j++){
                        ...
                        echo '<li class="item col-lg-4 col-md-3 col-sm-4 col-xs-6">
                          <div class="item-inner">
                            <div class="item-img">
                              <div class="item-img-info"> <a href="chitietsp.php?SP='.$fullsp[$j]['MaSanPham'].'" title="Sample Product" class="product-image"> <img width=200 height=200 src="../../products-images/'.$fullsp[$j]['Anh'].'" alt="Sample Product"> </a>
                              </div>
                            </div>
                            <div class="item-info">
