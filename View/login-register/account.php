                    ...
                    <fieldset class="col2-set">
                        ...
                        <div class="col-4 registered-users">
                            <div class="content">
                                ...
                                <ul class="form-list">
                                    <li>
                                        <label for="holot">Họ lót<span class="required">*</span></label>
                                        <br>
                                        <input type="name" title="holot" id="holot" name="holot" class="input-text" value="<?php echo $taikhoan['HoLot'] ?>">
                                    </li>
                                    <li>
                                        <label for="ten">Tên<span class="required">*</span></label>
                                        <br>
                                        <input type="name" title="ten" id="ten" name="ten" class="input-text" value="<?php echo $taikhoan['Ten'] ?>">
                                    </li>
                                    <li>
                                        <label for="email">Email<span class="required">*</span></label>
                                        <br>
                                        <input type="email" title="email" class="input-text" name="email" id="email" value="<?php echo $taikhoan['Email'] ?>" disabled="disabled">
                                    </li>
                                    <li>
                                        <label for="phone">Số điện thoại<span class="required">*</span></label>
                                        <br>
                                        <input type="text" title="phone" class="input-text" name="phone" id="phone" disabled="disabled" value="<?php echo $taikhoan['Phone'] ?>">
                                    </li>
                                </ul>
                                <div class="buttons-set">
                                    <button id="nut" name="nut" type="submit" value="Sua" class="button"><span>Sửa</span></button>
                                    <a href="password.php" class="button"><span>Đổi mật khẩu</span></a>
                                </div>
                            </div>
                        </div>
                        </form>
